...
function BoletinTable({ r, studentId }: { r: ReportCard; studentId: string }) {
  ...
  const courseId = typeof r.course === 'string'
    ? (r.course as string)
          ...
          <table className="min-w-[760px] w-full border-collapse text-sm">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="border border-neutral-300 p-2 text-center">{val(t1.writing)}</td>
                <td className="border border-neutral-300 p-2 text-center">{val(t2.writing)}</td>
                <td className="border border-neutral-300 p-2 text-center">{val(t3.writing)}</td>
              ...
              <tr>
                ...
                <td className="border border-neutral-300 p-2 text-center">{val(t1.speaking)}</td>
                <td className="border border-neutral-300 p-2 text-center">{val(t2.speaking)}</td>
                <td className="border border-neutral-300 p-2 text-center">{val(t3.speaking)}</td>
              ...
              <tr>
                ...
                <td className="border border-neutral-300 p-2 text-center">{val(t1.reading)}</td>
                <td className="border border-neutral-300 p-2 text-center">{val(t2.reading)}</td>
                <td className="border border-neutral-300 p-2 text-center">{val(t3.reading)}</td>
              ...
              <tr>
                ...
                <td className="border border-neutral-300 p-2 text-center">{val(t1.listening)}</td>
                <td className="border border-neutral-300 p-2 text-center">{val(t2.listening)}</td>
                <td className="border border-neutral-300 p-2 text-center">{val(t3.listening)}</td>
...
export default function StudentFinalCards() {
  ...
  /* CAMBIO MINIMO SOLO PARA EL AÑO */
